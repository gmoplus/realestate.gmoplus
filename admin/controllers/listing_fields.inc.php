    ...
    if ($_GET['action'] == 'add' || $_GET['action'] == 'edit') {
        ...
        if ($_GET['action'] == 'edit') {
            ...
            if (empty($field_info)) {
                ...
                if (!$_POST['fromPost']) {
                     ...
                     * @since 4.9.3
                     */
                    $rlHook->load('apPhpListingFieldsSimulatePost');
                }
            }
        }
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($f_type == 'file') {
                ...
                if ($_POST['file']['multipart_upload'] && (int) $_POST['file']['limit'] <= 1) {
                    $errors[] = str_replace('{field}', "<b>{$lang['files_limit']}</b>", $lang['notice_field_empty']);
                }
            }
