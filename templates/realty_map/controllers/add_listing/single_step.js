...
$(function(){
    ...
    var restoreFormData = function(form_data){
        ...
        for (var i in form_data) {
            ...
            if (form_data[i].name == 'plan') {
                form_data[i].value = selected_plan_id;
                $element = $selected_plan;
            }
    ...
    var changePlan = function(plan_id){
        ...
        if (!plan_id) {
            ...
            $plans_subscribe_input.prop('checked', false);
                ...
                if (status == 'success') {
                    ...
                    // Update plans selector
                        ...
                        if (plans_count > 0) {
                            ...
                            var dropdown_plan_id = parseInt($selected_plan.val());

                            // Previously selected plan is unavailable anymore
                            if (selected_plan_id && dropdown_plan_id && selected_plan_id != dropdown_plan_id) {
                                selected_plan_id = 0;
                            }
                            // Select current plan
                    ...
                    if (response.results.js_files || response.results.js_scripts) {
