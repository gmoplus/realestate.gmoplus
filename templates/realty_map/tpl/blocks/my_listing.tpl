	...
	<div class="nav">
		...
		<div class="navigation">
			<ul>
                ...
                <li class="nav-icon">
                    <button class="refresh-listing" id="refresh_{$listing.ID}" data-listing-id="{$listing.ID}" title="İlanı Yenile">
                        <span>Yenile</span>&nbsp;
                    </button>
                </li>
                {/if}
		...
		<div class="stat">
			<ul>
				...
				{if $listing.Status == 'active'}
				<li class="refresh-info-container">
					<span class="name">İlan Yenileme:</span>
					<span class="refresh-info">Kontrol ediliyor...</span>
				</li>
				{/if}
