...
<article class="item{if $listing.Featured} featured{/if}{if !$pictures_available} no-image{/if} col-sm-4{if !$side_bar_exists} col-md-3{/if} {rlHook name='tplListingItemClass'}">
