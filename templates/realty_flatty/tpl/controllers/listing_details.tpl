...
<div class="listing-details">
    ...
    <div class="d-flex flex-wrap flex-md-nowrap align-items-center top-navigation mb-3">
        <div class="d-flex flex-fill flex-nowrap mr-0 mr-md-3 mb-2 mb-md-0">
    ...
    <section class="d-flex flex-column position-relative flex-md-row main-section{if !$photos} no-picture{/if}">
        {if $photos}
            {include file=$componentDir|cat:'listing-details-gallery/_listing-details-gallery.tpl' noNavBar=true}
        {/if}

        <div class="details flex-fill{if $photos} ml-md-4{/if}">
			<div class="d-flex flex-wrap align-items-center justify-content-between">
                {if $price_tag_value}
    			    <div class="price-tag d-inline-block mb-3" id="df_field_price">{$price_tag_value}</div>
    			{/if}
			...
			{if $listing_type.Photo && $photos|@count > 0}
				<div class="table-container content-padding scrollbar">
