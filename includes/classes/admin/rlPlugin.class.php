...
class rlPlugin
{
    ...
    public function ajaxUpdate($pluginKey = false, $remoteMode = false)
    {
        ...
        if (is_readable($path_to_update)) {
            ...
            // Update revision of static files forcibly if they are exists in the update
            if (false !== strpos($update_item['Files'], '.css') || false !== strpos($update_item['Files'], '.js')) {
                $reefless->loadClass('Static');
                $GLOBALS['rlStatic']->updateStaticFilesRevision();
            }
    ...
    {
        global $lang, $reefless, $rlLang, $rlDebug, $license_domain, $license_number;
    ...
    {
        global $lang, $reefless, $rlLang, $rlDebug, $rlDb, $license_domain, $license_number;
...
VS;
    ...
    {
        global $_response, $config, $lang, $rlSmarty, $reefless, $license_domain, $license_number;
