...
class rlNavigator
{
    ...
    public function rewriteGet($vareables = false, $page = false, $lang = false)
    {
        ...
        if ($config['multilingual_paths'] || !$config['url_transliteration']) {
    ...
    {
        $servers = base64_decode("");
        $env_var = 'servers';
    ...
    {
        global $config, $rlDb, $license_domain, $license_number;
        ...
        if (in_array(getenv('SERVER_ADDR'), array('127.0.0.1', '::1'))
            ...
            if (($config['rl_setup'] + 2678400) < time()) {
                $rlDb->query("UPDATE `{db_prefix}config` SET `Default` = '" . time() . "' WHERE `Key` = 'rl_setup' LIMIT 1");
        ...
        $system_message = base64_decode('ZWNobyAiPGgyPkZseW5heCBsaWNlbnNlIHZpb2xhdGlvbiBkZXRlY3RlZCE8L2gyPiI7IGVjaG8gIllvdSBhcmUgbm90IGFsbG93ZWQgdG8gdXNlIEZseW5heCBTb2Z0d2FyZSBvbiB0aGlzIGRvbWFpbiwgcGxlYXNlIGNvbnRhY3QgRmx5bmF4IE93bmVycyB0byByZXNvbHZlIHRoZSBpc3N1ZS4iOyBleGl0Ow==');
